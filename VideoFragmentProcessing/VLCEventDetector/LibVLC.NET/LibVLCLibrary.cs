...
//  ==========================================================================
// 
//  $LastChangedRevision: 12763 $
//  $LastChangedDate: 2011-11-18 02:03:05 +0600 (Пт, 18 ноя 2011) $
    ...
    : IDisposable
  {
      ...
      try
      {
        ...
        try
        {
          ...
          try
          {
            ...
            //??? if((major != 1) && (minor != 2)) //   такой версии даже в архиве нет
            if ((major != 2) && (minor != 0))
    ...
    private static LibraryHandle GetOrLoadLibrary(string libVLCDirectory)
    {
      ...
      lock(m_LibraryHandles)
      {
        ...
        string program_files_path = VlcExec.FindPath("libvlc.dll");
