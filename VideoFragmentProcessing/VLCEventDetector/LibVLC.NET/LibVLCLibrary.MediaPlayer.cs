...
//  $LastChangedDate: 2011-11-08 02:22:05 +0600 (Вт, 08 ноя 2011) $
...
namespace LibVLC.NET
{
  ...
  partial class LibVLCLibrary
  {
    ...
    */
    ...
    //==========================================================================
    public void libvlc_video_set_callbacks(IntPtr mp, libvlc_video_lock_cb _lock, libvlc_video_unlock_cb unlock, libvlc_video_display_cb display, IntPtr handle/*???*/)
    {
      VerifyAccess();

      m_libvlc_video_set_callbacks(mp, _lock, unlock, display, handle/*???*/);
    }
